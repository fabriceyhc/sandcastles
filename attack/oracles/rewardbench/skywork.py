...
class SkyworkOracle(BaseRewardBenchOracle):
    """
    An oracle class that mirrors the interface of InternLMOracle (or INFORMOracle), 
    but uses QRM-Gemma-2-27B for reward scoring. QRM-Gemma-2-27B outputs a reward 
    distribution over 5 attributes: helpfulness, correctness, coherence, complexity, 
    and verbosity.
    """

    def __init__(
        self,
        model_path: str = "Skywork/Skywork-Reward-Gemma-2-27B-v0.2",
        device: str = "cuda",
